...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Ardrone3MediaRecordStateVideoStateChangedV2>)))
  ...
  (cl:format cl:nil "# Ardrone3MediaRecordStateVideoStateChangedV2~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: State of device video recording changed~%~%Header header~%~%# State of device video recording~%uint8 state_stopped=0  # Video is stopped~%uint8 state_started=1  # Video is started~%uint8 state_notAvailable=2  # The video recording is not available~%uint8 state~%# Error to explain the state~%uint8 error_ok=0  # No Error~%uint8 error_unknown=1  # Unknown generic error~%uint8 error_camera_ko=2  # Video camera is out of order~%uint8 error_memoryFull=3  # Memory full ; cannot save one additional video~%uint8 error_lowBattery=4  # Battery is too low to start/keep recording.~%uint8 error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Ardrone3MediaRecordStateVideoStateChangedV2)))
  "Returns full string definition for message of type 'Ardrone3MediaRecordStateVideoStateChangedV2"
  (cl:format cl:nil "# Ardrone3MediaRecordStateVideoStateChangedV2~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: State of device video recording changed~%~%Header header~%~%# State of device video recording~%uint8 state_stopped=0  # Video is stopped~%uint8 state_started=1  # Video is started~%uint8 state_notAvailable=2  # The video recording is not available~%uint8 state~%# Error to explain the state~%uint8 error_ok=0  # No Error~%uint8 error_unknown=1  # Unknown generic error~%uint8 error_camera_ko=2  # Video camera is out of order~%uint8 error_memoryFull=3  # Memory full ; cannot save one additional video~%uint8 error_lowBattery=4  # Battery is too low to start/keep recording.~%uint8 error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
