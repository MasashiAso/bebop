...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommonMavlinkStateMavlinkPlayErrorStateChanged>)))
  ...
  (cl:format cl:nil "# CommonMavlinkStateMavlinkPlayErrorStateChanged~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: FlightPlan play state error~%~%Header header~%~%# State of play error~%uint8 error_none=0  # There is no error~%uint8 error_notInOutDoorMode=1  # The drone is not in outdoor mode~%uint8 error_gpsNotFixed=2  # The gps is not fixed~%uint8 error_notCalibrated=3  # The magnetometer of the drone is not calibrated~%uint8 error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommonMavlinkStateMavlinkPlayErrorStateChanged)))
  "Returns full string definition for message of type 'CommonMavlinkStateMavlinkPlayErrorStateChanged"
  (cl:format cl:nil "# CommonMavlinkStateMavlinkPlayErrorStateChanged~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: FlightPlan play state error~%~%Header header~%~%# State of play error~%uint8 error_none=0  # There is no error~%uint8 error_notInOutDoorMode=1  # The drone is not in outdoor mode~%uint8 error_gpsNotFixed=2  # The gps is not fixed~%uint8 error_notCalibrated=3  # The magnetometer of the drone is not calibrated~%uint8 error~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
