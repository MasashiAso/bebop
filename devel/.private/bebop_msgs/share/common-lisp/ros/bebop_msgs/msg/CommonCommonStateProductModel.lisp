...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CommonCommonStateProductModel>)))
  ...
  "efa705dd25ca4badc44b32b9ceee2b68")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CommonCommonStateProductModel)))
  "Returns md5sum for a message object of type 'CommonCommonStateProductModel"
  "efa705dd25ca4badc44b32b9ceee2b68")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommonCommonStateProductModel>)))
  ...
  (cl:format cl:nil "# CommonCommonStateProductModel~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: Inform of the product model. This is used to customize the UI depending on the connected product.~%~%Header header~%~%# The Model of the product.~%uint8 model_RS_TRAVIS=0  # Travis (RS taxi) model.~%uint8 model_RS_MARS=1  # Mars (RS space) model~%uint8 model_RS_SWAT=2  # SWAT (RS SWAT) model~%uint8 model_RS_MCLANE=3  # Mc Lane (RS police) model~%uint8 model_RS_BLAZE=4  # Blaze (RS fire) model~%uint8 model_RS_ORAK=5  # Orak (RS carbon hydrofoil) model~%uint8 model_RS_NEWZ=6  # New Z (RS wooden hydrofoil) model~%uint8 model_JS_MARSHALL=7  # Marshall (JS fire) model~%uint8 model_JS_DIESEL=8  # Diesel (JS SWAT) model~%uint8 model_JS_BUZZ=9  # Buzz (JS space) model~%uint8 model_JS_MAX=10  # Max (JS F1) model~%uint8 model_JS_JETT=11  # Jett (JS flames) model~%uint8 model_JS_TUKTUK=12  # Tuk-Tuk (JS taxi) model~%uint8 model~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommonCommonStateProductModel)))
  "Returns full string definition for message of type 'CommonCommonStateProductModel"
  (cl:format cl:nil "# CommonCommonStateProductModel~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: Inform of the product model. This is used to customize the UI depending on the connected product.~%~%Header header~%~%# The Model of the product.~%uint8 model_RS_TRAVIS=0  # Travis (RS taxi) model.~%uint8 model_RS_MARS=1  # Mars (RS space) model~%uint8 model_RS_SWAT=2  # SWAT (RS SWAT) model~%uint8 model_RS_MCLANE=3  # Mc Lane (RS police) model~%uint8 model_RS_BLAZE=4  # Blaze (RS fire) model~%uint8 model_RS_ORAK=5  # Orak (RS carbon hydrofoil) model~%uint8 model_RS_NEWZ=6  # New Z (RS wooden hydrofoil) model~%uint8 model_JS_MARSHALL=7  # Marshall (JS fire) model~%uint8 model_JS_DIESEL=8  # Diesel (JS SWAT) model~%uint8 model_JS_BUZZ=9  # Buzz (JS space) model~%uint8 model_JS_MAX=10  # Max (JS F1) model~%uint8 model_JS_JETT=11  # Jett (JS flames) model~%uint8 model_JS_TUKTUK=12  # Tuk-Tuk (JS taxi) model~%uint8 model~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
