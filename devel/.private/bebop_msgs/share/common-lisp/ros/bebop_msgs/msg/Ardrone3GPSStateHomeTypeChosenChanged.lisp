...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Ardrone3GPSStateHomeTypeChosenChanged>)))
  ...
  (cl:format cl:nil "# Ardrone3GPSStateHomeTypeChosenChanged~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: The return home type chosen~%~%Header header~%~%# The type of the return home chosen~%uint8 type_TAKEOFF=0  # The drone will try to return to the take off position~%uint8 type_PILOT=1  # The drone will try to return to the pilot position~%uint8 type_FIRST_FIX=2  # The drone has not enough information, it will try to return to the first GPS fix~%uint8 type~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Ardrone3GPSStateHomeTypeChosenChanged)))
  "Returns full string definition for message of type 'Ardrone3GPSStateHomeTypeChosenChanged"
  (cl:format cl:nil "# Ardrone3GPSStateHomeTypeChosenChanged~%# auto-generated from up stream XML files at~%#   github.com/Parrot-Developers/libARCommands/tree/master/Xml~%# To check upstream commit hash, refer to last_build_info file~%# Do not modify this file by hand. Check scripts/meta folder for generator files.~%#~%# SDK Comment: The return home type chosen~%~%Header header~%~%# The type of the return home chosen~%uint8 type_TAKEOFF=0  # The drone will try to return to the take off position~%uint8 type_PILOT=1  # The drone will try to return to the pilot position~%uint8 type_FIRST_FIX=2  # The drone has not enough information, it will try to return to the first GPS fix~%uint8 type~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
