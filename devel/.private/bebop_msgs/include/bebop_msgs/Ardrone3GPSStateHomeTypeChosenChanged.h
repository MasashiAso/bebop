...
struct MD5Sum< ::bebop_msgs::Ardrone3GPSStateHomeTypeChosenChanged_<ContainerAllocator> >
{
  ...
  {
    return "58f8082f8dfe179b7b0f9d06a80de6e8";
  }

  static const char* value(const ::bebop_msgs::Ardrone3GPSStateHomeTypeChosenChanged_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x58f8082f8dfe179bULL;
  static const uint64_t static_value2 = 0x7b0f9d06a80de6e8ULL;
};
...
#\n\
# SDK Comment: The return home type chosen\n\
\n\
Header header\n\
\n\
