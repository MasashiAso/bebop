...
struct MD5Sum< ::bebop_msgs::CommonFlightPlanStateComponentStateListChanged_<ContainerAllocator> >
{
  ...
  {
    return "621a99a8086f23cd56095c43684a8297";
  }

  static const char* value(const ::bebop_msgs::CommonFlightPlanStateComponentStateListChanged_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x621a99a8086f23cdULL;
  static const uint64_t static_value2 = 0x56095c43684a8297ULL;
};
...
#\n\
# SDK Comment: List of state of drone flightPlan components\n\
\n\
Header header\n\
\n\
