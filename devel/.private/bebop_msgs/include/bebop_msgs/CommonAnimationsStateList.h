...
struct MD5Sum< ::bebop_msgs::CommonAnimationsStateList_<ContainerAllocator> >
{
  ...
  {
    return "5232f34d1c6e3b0aff894778e6be8b2c";
  }

  static const char* value(const ::bebop_msgs::CommonAnimationsStateList_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5232f34d1c6e3b0aULL;
  static const uint64_t static_value2 = 0xff894778e6be8b2cULL;
};
...
#\n\
# SDK Comment: List of animations state.\n\
\n\
Header header\n\
\n\
# Animation type.\n\
