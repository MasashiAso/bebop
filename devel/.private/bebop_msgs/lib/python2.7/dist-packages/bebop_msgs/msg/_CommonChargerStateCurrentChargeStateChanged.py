...
#
# SDK Comment: @deprecated The charge status of the battery changed.
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2B.pack(_x.status, _x.phase))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.status, _x.phase,) = _struct_2B.unpack(str[start:end])
      return self
