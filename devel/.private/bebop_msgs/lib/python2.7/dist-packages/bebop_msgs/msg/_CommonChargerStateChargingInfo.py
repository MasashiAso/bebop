...
#
# SDK Comment: Information of the charge.
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_4B.pack(_x.phase, _x.rate, _x.intensity, _x.fullChargingTime))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.phase, _x.rate, _x.intensity, _x.fullChargingTime,) = _struct_4B.unpack(str[start:end])
      return self
